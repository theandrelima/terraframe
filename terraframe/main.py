...
from terraframe.models import *


if __name__ == "__main__":
    project_path = "/Users/andrelima/python_projects/terraframe/tests/projects/my_project"
    ...
    #         with open(
    #             f"{deployment_directory.absolute()}/variables.tf", "w"
    #         ) as variables:
